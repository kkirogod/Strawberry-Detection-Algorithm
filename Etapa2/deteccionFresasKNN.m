function deteccion = deteccionFresasKNN(img, XTrain, YTrain)
    ...
    model = fitcknn(XTrain, YTrain, 'NumNeighbors', 20);
    deteccionVector = predict(model, double(valoresRGBImagen));
