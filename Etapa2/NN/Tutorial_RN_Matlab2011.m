% 2.1.2.2 Entrenamiento de NN

addpath("..\Datos\");

%% 3 MEJORES DESCRIPTORES
...
inputs = XoI(:, espacio3Ccas)';
outputs = YoI';

% SE ASUME QUE SE TRABAJA CON UN CONJUNTO DE DATOS ENTRADA-SALIDA YA CREADOS (HABRÍA QUE CARGARLOS): 
% inputs-outputs. 

% inputs: en cada columna los descriptores de cada muestra de entrenamiento.
...
save Datos\net3ccas net % PARA SALVAR LA RED ENTRENADA
...
Matriz_Test=Matriz_Test(:,1:5000); % reducimos el conjunto de test para que tarde menos
...
%% 6 MEJORES DESCRIPTORES

clear, clc, close all

load("XoI.mat");
load("YoI.mat");
load("espacio6Ccas.mat");

inputs = XoI(:, espacio6Ccas)';
outputs = YoI';
...
save Datos\net6ccas net % PARA SALVAR LA RED ENTRENADA
...
save Datos\net3ccasRGB net % PARA SALVAR LA RED ENTRENADA
...
save Datos\net3ccasLab net % PARA SALVAR LA RED ENTRENADA
